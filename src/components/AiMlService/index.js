  ...
  return (
    <div className="appDevWrapper">
      ...
      <div className="AppDevContainer" style={{ backgroundImage: `url(${aimlPage})` }}>
            ...
            <div className="textOneapp">Dwelling into the Future <br />with 
          <span style={{color: "#002699"}}>Generative AI </span>
          </div>
          <div className="subTextapp">
          Transformative power of AI & ML
          </div>
      ...
      <ClientsScrollBar />
      <BusinessPotential diffText={"AI/ML Solutions"} subText1={'Experience the power of Generative AI models to reconfigure your business efficiencies and speed. Our strategic AI solutions are aimed to revolutionize business operations and redefining your future business strategies.'} subText2={'Understanding AI and corresponding data models is the key to arriving at decision-making. Our experts transform raw data, offering a new dimension of understanding consumer behaviour, market analysis, and operational efficiency'}/>
      <Services services={aiServiceData} clickable={true} heightFactor={975} topText={'Our latest services'} bigText1={'Our Services'} bigText2={'your organization ahead'} smallText1={'We are pioneers of the digital approach, using leading-edge technology to'} smallText2={'simplify procedures and apply executive for your business.'} gridItems={3}/>
