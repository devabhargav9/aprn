    ...
    <div className="aboutCompanyContainer">
      ...
      <div className="aboutContent">
          ...
          <div className="topContentDiffAbtUs">
            <div className="abtcontent1">{props.headText}</div>
            {
              <div className="subText2">
                <span className="content2Blue">{props.subText1}</span>{" "}
                {props.subText2}
              </div>
            }
        ...
        <div className="extraContent">
          ...
          {props.extraText3 && (
            <div className="extraContent2">{props.extraText3}</div>
          )}
          {props.extraText4 && (
            <div className="extraContent2">{props.extraText4}</div>
          )}
          {props.showCTA && (
            <div className="learnMore" onClick={() => handleLearnMore()}>
              Learn More <img src={arrow} className="whiteArrow" />
            </div>
          )}
        </div>
      </div>
